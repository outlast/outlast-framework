...
var MooEditable = new Class({
	...
	initialize: function(el, options){
		...
		this.actions.each(function(action){
			...
			if (typeof act.dialogs == 'object'){
				act.dialogs.each(function(dialog, name){
			...
			if (act.events){
				act.events.each(function(fn, event){
	...
	attach: function(){
		...
		this.dialogs.each(function(action, name){
			action.each(function(dialog){
