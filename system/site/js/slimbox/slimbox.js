/*
	...
	Updated for Mootools 1.3 by Aron Budinszky <http://www.mozajik.org/>
	MIT-style license.
*/
...
var Slimbox = (function() {
	...
	*/
	...
	win.addEvent("domready", function() {
		...
		image = new Element("div", {id: "lbImage"});
		
		image.inject(center, 'bottom');
		...
		bottom = new Element("div", {id: "lbBottom"})
		bottom.inject(bottomContainer, 'bottom');
...
Slimbox.scanPage = function() {
	...
	}).slimbox({counterText: "{x} / {y}"}, null, function(el) {
