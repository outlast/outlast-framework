<?php
/**
 * Field definition for ratings.
 * @package Fields
 * @subpackage BuiltinFields
 **/
class zajfield_rating extends zajField {
	...
	const edit_template = 'field/rating.field.html';	// string - the edit template, false if not used
