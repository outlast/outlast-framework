<?php
/**
 * Field definition for a currency value.
 * @package Fields
 * @subpackage BuiltinFields
 **/
class zajfield_currency extends zajField {
	...
	const edit_template = 'field/currency.field.html';	// string - the edit template, false if not used
	...
	public function database(){
		// define each field
			$fields[$this->name.'_value'] = array(
					'field' => $this->name.'_value',
					'type' => 'float',
					'option' => array(),
 					'key' => '',
					'default' => 0,
			...
			$fields[$this->name.'_currency'] = array(
					'field' => $this->name.'_currency',
					'type' => 'varchar',
					'option' => array(0=>3),
 					'key' => '',
					'default' => $this->options['currency'],
					'extra' => '',
