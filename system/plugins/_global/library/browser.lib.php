...
class zajlib_browser extends zajLibExtension {
		 ...
		 */
		function is_browser($browserName) { return( 0 == strcasecmp($this->_browser_name, trim($browserName))); }

		/**
		 * The name of the browser.  All return types are from the class contants
		 * @return string Name of the browser
		 */
		public function get_browser() { return $this->_browser_name; }
		/**
		 * Set the name of the browser
		 * @param $browser The name of the Browser
		 */
		protected function setBrowser($browser) { return $this->_browser_name = $browser; }
		/**
		 ...
		 */
		protected function setPlatform($platform) { return $this->_platform = $platform; }
		/**
		 ...
		 */
		public function get_aol_version() { return $this->_aol_version; }
		/**
		 * Set the version of AOL
		 * @param $version The version of AOL
		 */
		protected function setAolVersion($version) { $this->_aol_version = preg_replace('[^0-9,.,a-z,A-Z]','',$version); }
		/**
		 * Is the browser from AOL?
		 * @return boolean True if the browser is from AOL otherwise false
		 */
		public function is_aol() { return $this->_is_aol; }
		/**
		 * Is the browser from a mobile device?
		 * @return boolean True if the browser is from a mobile device otherwise false
		 */
		public function is_mobile() { return $this->_is_mobile; }
		/**
		 * Is the browser from a robot (ex Slurp,GoogleBot)?
		 * @return boolean True if the browser is from a robot otherwise false
		 */
		public function is_robot() { return $this->_is_robot; }
		/**
		 * Set the browser to be from AOL
		 * @param $isAol
		 */
		protected function setAol($isAol) { $this->_is_aol = $isAol; }
		/**
		 * Get the user agent value in use to determine the browser
		 * @return string The user agent from the HTTP header
		 */
		public function get_user_agent() { return $this->_agent; }
		/**
		 * Set the user agent value (the construction will use the HTTP header value - this will overwrite it)
		 * @param $agent_string The value for the User Agent
		 */
		protected function setUserAgent($agent_string) {
			$this->reset();
