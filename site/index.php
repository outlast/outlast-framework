...
// !BEGIN CONFIGURATION
	...
	////////////////////////////////////////////////////////////////////////////////
	// - it is recommended you use the default settings unless you need
	//			backwards compatibility
	// - set the feature to true to enable it, false to disable it
	////////////////////////////////////////////////////////////////////////////////
		$zajconf['feature_xss_protection_enabled'] = true;
		$zajconf['feature_csrf_protection_enabled'] = false;
		$zajconf['feature_model_decoration_enabled'] = false;	// 2.0 enabled?
